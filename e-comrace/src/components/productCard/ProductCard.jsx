                    ...
                    <Tabs defaultIndex={0} className="" >
                        ...
                        <TabPanel>
                            <div className='px-4 mb-16 md:px-0'>
                                <h1 className='mb-5 text-3xl font-semibold text-center underline ' style={{ color: mode === 'dark' ? 'white' : '' }}>Product Details</h1>
                                <div className="flex justify-end ">
                                   <div onClick={goToAdd}>
                                   <button
                                        type="button"
                                        className="focus:outline-none text-white bg-pink-600 shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] border hover:bg-pink-700 outline-0 font-medium rounded-lg text-sm px-5 py-2.5 mb-2" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} > <div className="flex items-center gap-2">
                                ...
                                <div className="relative overflow-x-auto ">
                                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400 ">
                                      ...
                                      {product.map((item,index)=>{
                                        ...
                                        return(
                                            <tbody className=''>
                                            <tr className="border-b bg-gray-50 dark:border-gray-700" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                                                ...
                                                <td className="px-6 py-4">
                                                    <div className="flex gap-2 ">
                                                        <div className="flex gap-2 text-black cursor-pointer " style={{ color: mode === 'dark' ? 'white' : '' }}>
                        ...
                        <TabPanel>
                            ...
                            <div className="relative mb-16 overflow-x-auto">
                                <h1 className='mb-5 text-3xl font-semibold text-center underline ' style={{ color: mode === 'dark' ? 'white' : '' }}>Order Details</h1>
                                        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400" >
                        ...
                        <TabPanel>
                            ...
                            <div className="relative mb-10 overflow-x-auto">
                                <h1 className='mb-5 text-3xl font-semibold text-center underline ' style={{ color: mode === 'dark' ? 'white' : '' }}>User Details</h1>
                                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                    <thead className="text-xs text-black uppercase bg-gray-200 " style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                                        <tr>
                                            <th scope="col" className="px-6 py-3">
