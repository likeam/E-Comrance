    ...
    <div className="bg-gray-200" style={{ backgroundColor: mode === 'dark' ? 'rgb(55 57 61)' : '', color: mode === 'dark' ? 'white' : '', }}>
        <div className="container flex flex-col items-center px-5 py-3 mx-auto sm:flex-row">
            <Link to={'/'} className='flex'>
                <div className="flex ">
                    <h1 className='px-2 py-1 text-2xl font-bold text-black rounded ' style={{ color: mode === 'dark' ? 'white' : '', }}>E-Sargodha PK</h1>
                </div>
            </Link>
            <p className="mt-4 text-sm text-gray-500 sm:ml-6 sm:mt-0" style={{ color: mode === 'dark' ? 'white' : '' }}>© 2023 E-Sargodha PK —
                <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="ml-1 text-gray-600" target="_blank" style={{ color: mode === 'dark' ? 'white' : '' }}>www.e-sargodha.pk</a>
            </p>
