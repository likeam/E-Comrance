    ...
    <>
        <div className="font-bold text-center text-white rounded-lg ">
            <button
                type="button"
                onClick={openModal}
                className="w-full py-2 font-bold text-center text-white bg-green-600 rounded-lg bg-violet-600"
            >
                Buy Now
            </button>
        </div>
            ...
            <Dialog as="div" className="relative z-10" onClose={closeModal}>
                ...
                <div className="fixed inset-0 overflow-y-auto">
                    <div className="flex items-center justify-center min-h-full p-4 text-center">
                        ...
                        >
                            <Dialog.Panel className="w-full max-w-md p-2 overflow-hidden text-left align-middle transition-all transform shadow-xl rounded-2xl bg-gray-50">
