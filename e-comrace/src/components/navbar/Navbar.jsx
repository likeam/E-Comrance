              ...
              <Dialog.Panel className="relative flex flex-col w-full max-w-xs pb-12 overflow-y-auto bg-white shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div className="px-4 py-6 space-y-6 border-t border-gray-200">
                  ...
                  <div className="flow-root">
                    {user?   <Link to={'/order'} style={{ color: mode === 'dark' ? 'white' : '', }} className="block p-2 -m-2 font-medium text-gray-900">
                      Order
                    </Link>  : '' }
                   
                  </div>

                  { user?.user?.email === 'engrabdulrehman@live.com' ? <div className="flow-root">
                    <Link to={'/dashboard'} className="block p-2 -m-2 font-medium text-gray-900" style={{ color: mode === 'dark' ? 'white' : '', }}>
                      admin
                    </Link>
                  </div> : '' }
                  ...
                  <div className="flow-root">
                    ...
                    { user? <a 
                      onClick={logout}
                    className="block p-2 -m-2 font-medium text-gray-900 cursor-pointer" style={{ color: mode === 'dark' ? 'white' : '', }}>
                      Logout
                    </a>  : '' }
                    
                  </div>
                  <div className="flow-root">
                    <Link to={'/'} className="block p-2 -m-2 font-medium text-gray-900 cursor-pointer">
                      <img
                        className="inline-block w-10 h-10 rounded-full"
                        src="https://avatars.githubusercontent.com/u/92205472?v=4"
                ...
                <div className="px-4 py-6 border-t border-gray-200">
                  <a href="#" className="flex items-center p-2 -m-2">
                    ...
                    />
                    <span className="block ml-3 text-base font-medium text-gray-900" style={{ color: mode === 'dark' ? 'white' : '', }}>Pakistan</span>
            ...
            <div className="flex items-center h-16">
              ...
              <div className="flex ml-4 lg:ml-0">
                <Link to={'/'} className='flex'>
                  <div className="flex ">
                    <h1 className='px-2 py-1 text-2xl font-bold text-black rounded ' style={{ color: mode === 'dark' ? 'white' : '', }}>E-Sargodh Pakistan</h1>
                  </div>
                </Link>
              </div>
              ...
              <div className="flex items-center ml-auto">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  ...
                  { user?.user?.email === 'engrabdulrehman@live.com' ?  <Link to={'/dashboard'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                    Admin
                  </Link> : '' }
                  {user?    <a  
                    onClick={logout}
                ...
                <div className="hidden lg:ml-8 lg:flex">
                  <a href="#" className="flex items-center text-gray-700 ">
                    <img
                      src="https://cdn.pixabay.com/photo/2013/07/13/14/16/pakistan-162383_1280.png"
                      alt=""
                      className="flex-shrink-0 block w-5 h-auto"
                    />
                    <span className="block ml-3 text-sm font-medium" style={{ color: mode === 'dark' ? 'white' : '', }}>Pakistan</span>
                  </a>
                </div>
                <div className="hidden lg:ml-8 lg:flex">
                  <a href="#" className="flex items-center text-gray-700 ">
